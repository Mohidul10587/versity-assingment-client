    ...
    <div className="mt-20">
      <div className="bg-blue-700 flex sm:p-3 p-2">
        ...
        <div className="w-1/2 sm:p-6 p-2 text-white border-r">
          ...
          <p className="w-24 h-0.5 bg-white mt-4 mb-4"></p>Shafipur <br />{" "}
          Kaliakoir, Gazipur .
        </div>

        {/* navigation div start here  */}
        <div className="w-1/2 sm:p-6 p-2">
          ...
          <div className="flex">
            <a href="#" target="_blank_">
              <svg
                ...
                strokeWidth="0"
                viewBox="0 0 448 512"
                className="hover:bg-white bg-white text-blue-700 border-1 mr-2 text-2xl"
                height="1em"
                width="1em"
      ...
      <div className="bg-blue-700 text-white text-center py-3 border-t">
        <p>
          © Copyright By
          <a href="#" target="_blank_">
            {" "}
