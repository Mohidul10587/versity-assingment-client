          ...
          <div className="">
            <div className="w-full mt-10 ">
              <form
                ref={form}
                onSubmit={sendEmail}
                className="md:w-[1200px] px-4"
              >
                <div className="md:flex">
                  <input
                    className="mt-2 w-full rounded-md p-2 border-[1px] focus:border-2 focus:border-blue-600 border-blue-600 focus:outline-none  md:mr-4"
                    name="user_name"
                    placeholder="Name"
                    type="text"
                  />
                  <br />
                  <input
                    className="mt-2 w-full rounded-md p-2 border-[1px] focus:border-2 focus:border-blue-600 border-blue-600 focus:outline-none  md:mx-2"
                    name="user_email"
                    placeholder="Email"
                    type="email"
                  />
                  <br />
                  <input
                    className="mt-2 w-full rounded-md p-2 border-[1px] focus:border-2 focus:border-blue-600 border-blue-600 focus:outline-none  md:ml-4"
                    name="phone"
                    placeholder="Phone"
                    type="phone"
                  />
                ...
                <textarea
                  className="mt-6 w-full rounded-md p-2 border-[1px] focus:border-2 focus:border-blue-600 border-blue-600 focus:outline-none"
                  name="message"
                  placeholder="Massage"
                  cols={30}
                  rows={10}
                ...
                <input
                  className="mt-2 w-full rounded-md p-2 border-[1px] focus:border-2 focus:border-blue-600 border-blue-600 focus:outline-none hover:bg-color-second  hover:text-blue-600 font-bold text-xl"
                  type="submit"
                  value="SUBMIT"
                />
                <br />
